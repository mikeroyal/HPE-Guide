...
[HPE GreenLake](https://developer.hpe.com/platform/hpe-greenlake/home/) is an IT-as-a-Service (ITaaS) managed cloud experience that accelerates your transformation by helping you to design, build, manage, and optimize your on and off-premises clouds.

[HPE Deep Learning Cookbook](https://developer.hpe.com/platform/hpe-deep-learning-cookbook/home/) is a set of tools to guide the choice of the best hardware/software environment for a given deep learning workload.

[Aruba Developer Hub](https://developer.hpe.com/platform/aruba/home/) is a comprehensive resource for developers that includes Aruba APIs and documentation to streamline the development of innovative, next-generation edge applications leveraging the Aruba Edge Services Platform.

[HPE Developer Community Forum](https://developer.hpe.com/community)

[HPE Certification and Learning](https://certification-learning.hpe.com/TR/courses)

[Workshops-on-Demand](https://hackshack.hpedev.io/workshops)

[HPE Ezmeral Learn On-Demand Training](https://learn.ezmeral.software.hpe.com)

[HPE Expert Technology Training](https://education.hpe.com/us/en/training/index.html)

[HPE IT Training](https://education.hpe.com/ww/en/training/index.html)

[HPE Networking and Aruba Training](https://education.hpe.com/us/en/training/portfolio/networking.html)

[HPE Courses on Udemy](https://www.udemy.com/courses/search/?src=ukw&q=HPE)

# HPE Tools

[Back to the Top](https://github.com/mikeroyal/HPE-Guide/blob/main/README.md#table-of-contents)

[HPE OneView](https://www.hpe.com/us/en/integrated-systems/software.html) is an integrated IT management solution that transforms compute, storage, and networking into software-defined infrastructure to automate tasks and accelerate business.

[HPE Helion OpenStack Cloud Software HPE Helion OpenStack Cloud Software (HOS 8)](https://buy.hpe.com/us/en/enterprise-solutions/cloud-solutions/helion-cloud/helion-openstack-cloud-software/hpe-helion-openstack-cloud-software/p/1010838414) is an open and extensible scale-out cloud platform used for building on-premises private clouds with the option of participating in a hybrid cloud when required.

[HPE Helion OpenStack](https://buy.hpe.com/us/en/enterprise-solutions/cloud-solutions/helion-cloud/helion-openstack/hpe-helion-openstack/p/7261055) is a hardened, extensible product designed to deliver enterprise grade private cloud computing while adhering tightly to OpenStack software API standards and services.

[HPE Ezmeral Container Platform](https://developer.hpe.com/platform/hpe-ezmeral-container-platform/home/) is an enterprise-grade container platform designed to deploy both cloud-native and non-cloud-native applications using Kubernetes. All running on bare-metal or virtualized infrastructure, on any public cloud, and at the edge.

[HPE Ezmeral Data Fabric](https://developer.hpe.com/platform/hpe-ezmeral-data-fabric/home/) is a sophisticated data fabric that allows
you to store, manage and access your data from edge to core to cloud at any scale or speed that you need.

[SPIFFE and Spire Projects](https://developer.hpe.com/platform/spiffe-and-spire-projects/home/) is a set of open-source standards for securely authenticating software services in dynamic and heterogeneous infrastructures through platform-agnostic, cryptographic identities. SPIRE is an open-source system that implements the SPIFFE specification in a wide variety of environments.

[HPE GreenLake container services](https://www.hpe.com/us/en/greenlake/containers.html) is powered by the HPE Ezmeral Container Platform that provides a unified control plane for cloud-native and non-cloud-native apps that automates and manages on-premises, public cloud, and hybrid container deployments.

[HPE GreenLake for Machine Learning](https://www.hpe.com/us/en/greenlake/machine-learning.html) is an enterprise-grade ML service that enables developers and data scientists to rapidly build, train, and deploy ML models from pilot to production, at any scale. This preconfigured solution comprises an optimized hardware stack and is powered by [HPE Ezmeral ML Ops](https://www.hpe.com/us/en/greenlake/ml-ops.html). It provides data scientists with self-service access to a sandbox environment for prototyping and testing, to eliminate IT provisioning delays, ensure repeatability, and accelerate time-to-value.

[HPE GreenLake for Virtual Machines](https://www.hpe.com/us/en/greenlake/virtual-machines.html) is a service that provides virtualized infrastructures with exceptional flexibility for DevOps and data scientists. 

[HPE GreenLake for Private Cloud](https://www.hpe.com/us/en/greenlake/private-cloud.html) is a service that provides the flexibility of private cloud services at the edge, in colocations, and in your data center.

[HPE GreenLake for Big Data ](https://www.hpe.com/us/en/greenlake/big-data.html) is a service that helps you accelerate your Big Data outcomes by reducing the complexity and cost of deploying and managing your Hadoop environments.

[HPE GreenLake for SAP HANA](https://www.hpe.com/us/en/greenlake/sap-hana.html) is a service that helps you get the most out of your SAP HANA platform. HPE supports rigorous availability, security, and reliability standards, which often span on-premises, hybrid architectures, and even multiple clouds.

[HPE GreenLake database as a service (DBaaS)](https://www.hpe.com/us/en/greenlake/database-platform.html) is a service that gets you get an open-source, Oracle-compatible data management platform, built on optimized hardware from HPE, all in a pay-per-use model. Pair services as needed for migration, integration, or performance-tuning.

[HPE GreenLake for VDI](https://www.hpe.com/us/en/greenlake/vdi.html) is a service that provides secure on-premises virtual desktop infrastructures, tailored to users’ needs, that let you avoid high up-front costs, speed time to value, and scale seamlessly to align resources with demand.

[HPE GreenLake for Data Protection](https://www.hpe.com/us/en/greenlake/data-protection.html) is a consumption-based service that’s designed to protect data for your service level agreements (SLAs) and delivered without up-front capital expense or overprovisioning risk. It includes preconfigured on-premises solutions make it simple to choose the option that meets your rapid recovery needs, with on-demand cloud services option to extend protection to cloud. 

[HPE GreenLake for Aruba](https://www.hpe.com/us/en/greenlake/networking.html) is a service that accelerates your network operation at every step in the lifecycle. By utilizing a managed and optimised network as a monthly payment, you gain efficiencies and reduce exposure from initial capital expenditure outlays.

[HPE GreenLake for Storage](https://www.hpe.com/us/en/greenlake/storage.html) is a service that provides a set of workload-optimized, consumption-based solutions built on an intelligent data platform and delivered to you entirely as a service. Built-in buffer capacity eliminates the risk of overprovisioning by ensuring you’ll be able to handle any unexpected demand, and HPE will work with you to add resources as needed before your business needs additional capacity.

[HPE GreenLake for Compute](https://www.hpe.com/us/en/greenlake/compute.html) is a service that provides a range of bare-metal configurations delivered and operated for you and consumed on a pay-per-use basis. Pay only for the resources you consume, and built-in buffer capacity enables you to handle both steady growth and unexpected spikes in demand. Even better, our broad range of pre-configured options, designed as modular building blocks of industry-leading HPE technologies, means your solution can be delivered to your on-premises or co-located data center or edge location in a matter of days.

[HPE GreenLake for High Performance Computing](https://www.hpe.com/us/en/greenlake/high-performance-compute.html) is a service that provides excellent flexibility, scalability, and control of HPC solutions with a cloud service consumption model on premises. In addition, HPE helps reduce the cost and complexity of maintaining an HPC environment with skilled resources who implement and operate the environment for you.

[HPE GreenLake for Governance and Management](https://www.hpe.com/us/en/greenlake/compliance-monitoring.html) is a compliance monitoring service helps ensure you meet your compliance, security, and control requirements for your workloads running on public clouds including AWS and Azure.

[HPE GreenLake for Financial Services](https://www.hpe.com/us/en/greenlake/financial-services-industry.html) is a service that provides the IT infrastructure delivered with cloud-like speed and agility, in an as-a-service delivery model, allowing you to focus on your bottom line while innovating and delivering value to your customers.

[HPE GreenLake for Healthcare](https://www.hpe.com/us/en/greenlake/healthcare.html) is a service that provides healthcare technology solutions that combine proven performance, industry expertise, and as-a-service delivery that removes financial barriers to technological advancement.

[HPE GreenLake for Manufacturing](https://www.hpe.com/us/en/greenlake/manufacturing.html) is a service that provides workload-optimized services that enable faster access to data and insights, combining the automation, agility, and economics of the cloud with the security and performance of on-premises infrastructure. Allowing IT to deliver a modernized solution that is adaptable, scalable, secure, and streamlined to provide business efficiencies from the shop floor to the executive suite.

[HPE GreenLake for Publice Sector](https://www.hpe.com/us/en/greenlake/public-sector.html) is a service provides the innovation of the cloud while preserving control for applications and workloads that need to run on premises. It can help you accelerate IT modernization, reduce costs, and harness the power of data to operate and serve your citizens.

[HPE GreenLake for Telco](https://www.hpe.com/us/en/greenlake/telco.html) is a service provides both enterprise and telco solutions spanning from the enterprise edge, across the telco network, and into the multi-cloud environment. Bringing together a set of open, edge to cloud solutions—including an ecosystem of partners to help telcos transform and realize the potential of 5G, edge, and the cloud, available with automated as-a-service delivery through HPE GreenLake.

# HPE DevOps Tools Integration

[Back to the Top](https://github.com/mikeroyal/HPE-Guide/blob/main/README.md#table-of-contents)


**[Start building with HPE OneView SDK for Anisble](https://github.com/HewlettPackard/oneview-ansible)**

**[Start building with HPE OneView SDK for Terraform](https://github.com/HewlettPackard/terraform-provider-oneview/releases/tag/v1.3.0)**

**[Start building with HPE OneView SDK for Chef](https://github.com/HewlettPackard/oneview-chef)**

**[Start building with HPE OneView SDK for Puppet](https://github.com/HewlettPackard/oneview-puppet)**
...
**[Start building with HPE OneView SDK for Python](https://github.com/HewlettPackard/oneview-python)**
...
**[Start building with HPE OneView SDK for Ruby](https://github.com/HewlettPackard/oneview-sdk-ruby)**
...
**[Start building with HPE OneView SDK for Go](https://github.com/HewlettPackard/oneview-golang)**
...
**[Start building with HPE OneView SDK for PowerShell](https://github.com/HewlettPackard/POSH-HPOneView)**
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/HPE-Guide/pulls).
